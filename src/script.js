window.addEventListener("load", () => { // Extensions
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
    ...
    document.getElementById('docassets').style.backgroundImage = "url(https://lh3.googleusercontent.com/JwLoyKugJQ-GNq-hGK94I23EJETk2_2Wi3UrLlShwBa1UTgiWFQQ4uvmKfxi7pacYwBbjg1IxOeus7Tlv8h5-Lui_5Q=w128-h128)"
    document.getElementById('swapper').style.backgroundImage = "url(https://raw.githubusercontent.com/MarkLyck/asset-swapper-chrome-extension/master/dist/asset_swapper_icon_128.png)"
  ...
  window.addEventListener("load", () => { // Evotree
      ...
      evo.classList.add("blue", "evo", "evo-close")
  ...
  <path style=" stroke:none;fill-rule:evenodd;fill:rgb(100%,100%,100%);fill-opacity:1;" d="M 9.433594 12.71875 C 9.433594 11.601562 8.527344 10.695312 7.410156 10.695312 C 6.871094 10.695312 6.355469 10.90625 5.976562 11.285156 C 5.59375 11.667969 5.382812 12.183594 5.382812 12.71875 C 5.382812 13.839844 6.289062 14.746094 7.410156 14.746094 C 8.527344 14.746094 9.433594 13.839844 9.433594 12.71875 Z M 9.433594 12.71875 "/>
    ...
    evoBox.outerHTML = `
    <img src="https://media.discordapp.net/attachments/865283433265496085/1016445883895787701/evolution_tree_themed.png?width=939&height=676">
    `
